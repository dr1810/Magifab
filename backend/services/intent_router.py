...
def _routes() -> tuple[IntentRoute, ...]:
    return (
        ...
        IntentRoute("conversation", ("dialogue", "relationship", "event"), "What people said, meant, wanted, or discussed in a conversation."),
        IntentRoute("memory", ("event", "timeline", "character", "relationship"), "A callback, earlier story memory, or information the reader should recall."),
        ...
        IntentRoute("world_building", ("lore", "location", "paragraph", "glossary"), "How the fictional world, society, culture, rules, or setting works."),
        IntentRoute("lore", ("lore", "glossary", "paragraph", "timeline"), "Background knowledge, history, mythology, institutions, or established story facts."),
        IntentRoute("summary", ("scene", "event", "timeline", "paragraph"), "A concise summary of a scene, page, chapter, or section."),
        ...
        IntentRoute("book_specific", ("paragraph", "glossary", "lore", "timeline"), "A book paragraph, page, chapter, sentence, prose passage, or reading-specific question."),
    )
